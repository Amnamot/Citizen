...
func Vices(w http.ResponseWriter, r *http.Request) {
	...
	if vice_1 != "" {
		_, err = dbpool.Exec(context.Background(), `INSERT INTO vices (name, yes, no, ignore, user_id) VALUES ($1, 0, 0, 0, $2);`, vice_1, data.User.ID)
	...
	if vice_2 != "" {
		_, err = dbpool.Exec(context.Background(), `INSERT INTO vices (name, yes, no, ignore, user_id) VALUES ($1, 0, 0, 0, $2);`, vice_2, data.User.ID)
